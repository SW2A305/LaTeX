...
Begge databaser blev implementeret under projektarbejdet, grundet komplikationer med vores første valg af database, Entity Framework. 
...
\fxnote{Her skal vi muligvis indsætte noget visuelt omkring opbygning af vores specifikke DAL-løsning.}
...
Migrations kom i vejen for hinanden og gav konflikter, der krævede, at gruppens medlemmer regelmæssigt skulle slette hver tabel og kalde kommandoen \texttt{Update-Database}, som får \ac{EF} til at gennemløbe alle migrations og udføre handlingerne i disse.
\fxnote{Lang sætning. Bør nok omskrives.}
...
\fxnote{Skal der eventuelt tilføjes noget her om ``lazy loading'', eller vil det være for meget?}

...
Indtil nu er problemet om fritidsklubbers administrative opgaver blevet belyst og analyseret vha. Laudon og Laudons modellen beskrevet i \myref{chap:struktur-af-problemanalyse}. \fxnote{Skal det være i bestemt ental? Modellen: (Søren)}
...
Ved at analysere videre på de direkte forhold vedrørende en sejlklub, blev der dannet en forståelse for, hvilke problemer en sejlklub med sejlerskole har, som kan løses vha. et administrationssystem.\fxnote{Skal vi skrive Management system her? (Søren)}


\section{Interessenterne for sejlklubber}

Der var forskellige interessenter for sejlklubberne, og de havde varierende mængder af interesse i projektet. \fxnote{Caspar: Drop mængder, evt ``har varierende interesse i projektet''}
...
Hvis systemet ikke har de funktioner, som de efterspørger, vil det ikke være den gode løsning, som de gerne vil have.\fxnote{Efterspørger igen her, hvad ændrede vi det til? (Søren)} 
Dette gælder for alle de tre nævnte interessenter. 
Det skal dog understreges, at de ikke vil bruge samme dele af systemet. 
Dette skyldes, at medlemmerne ikke skal kunne oprette undervisningsdage mm., da det kun er underviserne, der skal have tilladelse til dette. \fxnote{Slet dette? ER det ikke løsningsorienteret? (Søren)}
...
\begin{itemize}
  ...
  \item Reservation af både. \fxnote{Tristan: Jeg har rettet det fra ``Booking'' til ``Reservation''.}
...
Sejlklubben Sundet,\fxnote{Tristan: Skal det komma være der?} viste sig at have flere forhold at organisere end de andre klubber der er undersøgt, og derfor afgrænses projektet til konkret at designe et IT-system til Sejlklubben Sundet. 
Dette gøres, da hvis et system kan hjælpe Sundet, er det blevet konkluderet\fxnote{Caspar: Hvor har vi konkluderet dette? Søren: Ovenfor når vi siger at hvis det virker til en sejlklub kan det også virek til andre fritidsklubber, hvis man fjerne nogle funktionaliteter}, at det også kan hjælpe andre sejlklubber, der har færre forhold at holde styr på.
...
Da dette projekt er udarbejdet i løbet af 2. semester på Aalborg Universitet, er der ikke uanede mængder af tid.\fxnote{Lyder lidt talesprogsagtigt 'uanede mængder', måske skrive noget med begrænset tid. - Thomas --- Tristan: Desuden vil et semesterprojekt vel stort set altid have begrænset tid?}
...
Denne afgrænsning finder sted, da hvis funktionerne for klubben kan fungerer på computeren, skal det tilkobles en server, for at kunne tilgås fra flere forskellige computere. \fxnote{Hvad menes der med ``computeren'' er det den nede i klubben, eller enhver?} \fxnote{Tristan: Eventuelt ``skal kunne fungere på...''?}
Derfor ser projektgruppen altså funktionerne for Sejlklubben Sundet som værende de vigtige ting at udvikle, selvom systemet mister noget af sin effektivitet uden internetopkoblingen.\fxnote{Nikolaj: Omformulering: " selvom systemet mister sin brugbarhed uden internetopkoblingen}\fxnote{Marc: Vi gør kun opmærksom på at kravet om internet ikke vil bliver opfyldt, hvad med medlemsopretning samt betaling af lejede både? dette gør vi ikke i projektet men vi gør ikke opmærksom på at dette undlades --- Tristan: Der er i det hele taget flere ting vi nævner, men aldrig tager stilling til, eller løser.}
Dette ses som værende acceptabelt, da systemet ikke skal tages i brug af klubben, da dette er et projekt lavet i forbindelse med uddannelsen på Softwareingeniørstudiet ved Aalborg Universitet.\fxnote{Tristan: Ved ikke om dette måske er lidt for tyndt et argument?}
...
Som det første vil der komme en kravspecifikation for systemet, på baggrund af denne afgrænsning.\fxnote{Caspar: Skal tilpasses da næste ikke kravspec, men user stories}

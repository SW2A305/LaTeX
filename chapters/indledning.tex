...
I moderne tider er computere og smartphones i højere grad blevet en integreret del af langt størstedelen af personers hverdag. \fxnote{Lyder det ikke lidt mærkeligt ``.. langt størstedelen af personers hverdag?'' tror det kræver en omformulering} 
Dog er det ikke altid, at foreninger og fritidsklubber anvender disse nye værktøjer på en effektiv og optimal måde. 
Dette er det problem, som gruppen vil undersøge, samt forsøge at bidrage til en løsning. \fxnote{``med en løsning'' eventuelt i stedet for ``til en løsning''} 
...
Problemanalysen har til formål, at opnå et overblik over hvilke interessenter der er, deres organisation og den teknologi der allerede findes. 

...
programmer som løsning på et problem i en problemstilling kontekst.''}\fxnote{Er dette citeret ordret? For det
ville være mere korrekt med ``problemstillingskontekst'' med eller uden mellemrum, afhængigt af, hvordan det
skal læses.} Helt konkret skal der produceres et program i C\#, der skal virke som en hel eller delvis løsning
...
personers hverdag. \fxnote{Lyder det ikke lidt mærkeligt ``.. langt størstedelen af personers hverdag?'' tror
det kræver en omformulering} \fxnote{Eventuelt ``.. mange personers hverdag.'' medmindre vi har belæg for at
påstå, at det er størstedelen?} Dog er det ikke altid, at foreninger og fritidsklubber anvender disse nye
værktøjer på en effektiv og optimal måde. Dette er det problem, som gruppen vil undersøge, samt forsøge at
bidrage til en løsning. \fxnote{``med en løsning'' eventuelt i stedet for ``til en løsning''}
...
programspecifikation, som vil være de krav der er opstillet, på baggrund af analysen. \fxnote{Her skal
tilføjes lidt ang. hvad løsningsdelen kommer til helt konkret at indeholde.}

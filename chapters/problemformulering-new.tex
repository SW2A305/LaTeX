\chapter{Problemformulering (NEW)}\label{chap:problemformulering-new}

Indtil nu er problemet om fritidsklubbers administrative opgaver blevet belyst og analyseret vha. Laudon og
Laudons model beskrevet i \myref{sec:struktur-af-problemanalyse}. Det er nu ud fra denne analyse muligt at
komme frem til en problemformulering, som vil hjælpe til at finde en løsning for fritidsklubber og ikke mindst
sejlklubberne.

Der blev i kapitlet om fritidsklubber i \myref{Fritidsklubber} afgrænset til sejlklubber, da disse viste sig
...
for de andre former for fritidsklubber. \fxnote{Whut?!} Derfor ved at analysere videre på de
...
at regninger kan udskrives ud i et \fxnote{Lyder underligt\ldots}, og muligvis endda håndtere det gennem
...
klubhuset, og der skal derfor være en internetopkobling i klubhuset. \fxnote{Er det nu også dét? Ville det
ikke være tilstrækkeligt med en tablet, hvis nu klubhuset ikke havde internet? Eller hvis de ville kunne låse
deres tablet inde i et sikret skab, eller noget helt tredje?}

...
Problemet kan løses ved hjælp af et management system, til at håndtere dokumentation for sejlklubben og gøre det overskueligt. \fxnote{Skal vi ikke sige det som om at det muligvis kan løse det?}
I følgende afsnit undersøges der, hvilke krav et management system for Sejlklubben Sundet skal have. \fxnote{Caspar: Bør User stories ikke være nævnt her?}
...
For at gøre dette muligt kræves der således to ting: En database af medlemmer, samt en form for begivenhedskalender.\fxnote{Der er ikke en begivenhedskalender, men agenda - Thomas}\fxnote{Vel ikke en database, men en måde hvorpå man kan håndtere medlemmer? (Søren)}
...
\begin{enumerate}
  \item Medlemshåndtering\fxnote{Marc: Så vil jeg da mene vi har ignoreret førsteprioritet idet vi ikke kan oprette medlemmer eller kræve penge fra dem, hvis ikke dette skal fjernes skal vi da have et godt argument for hvorfor vores program ikke kan det vi prioritere højest. Dette passer heller ikke med hvad der kommer senere hvor det virker som om at programmet skal kunne differentiere mellem medlemmer, ikke håndtere medlemmer}
  \item Brugerlogin
...
Det er et krav, at man kan udnytte medlemmerne i klubben, så man kan registrere hvem der er tilmeldt de forskellige reservationer eller lignende.\fxnote{Findes der ikke et bedre ord end udnytte, måske 'bruge' med lidt omformulering? - Thomas --- Tristan: Fedt med et krav om udnyttelse af medlemmerne. Hvad med ``benytte'' eller ``anvende'', med mindre vi omformulerer sætningen en del?}
...
Underviserne skal også kunne oprette, slette og redigere hold på skolen, hvis nogle skulle melde sig ud eller ved sæsonstart. \fxnote{Caspar: Kan det sidste efter kommaet ikke nukes?}\fxnote{Marc: Om ikke andet skal ''eller ved sæsonstart'' fjernes, giver ingen mening i konteksten}

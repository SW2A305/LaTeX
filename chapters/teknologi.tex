...
hjemmefra. \fxnote{Lang knudret sætning overvej omformulering}
...
at gøre tingene på, bl.a. hos firmaet \textit{TransIP} \fxnote{Hvad er dette? Et firma?} skal brugeren selv
...
\subsubsection*{Virtuelle servere} \fxnote{Overvej https://www.vpspro.dk/ her, det er et plus at det er dansk
og windows.}
...
\textit{Windows Forms} blive anvendt til at skabe en brugergrænseflade. \fxnote{Skal jeg komme ind på det med
Windows Forms her? og i så fald skal der så argumenteres for valget af forms over MVC og WPF? + "sharp" skal
lige ændres til det korrekte tegn -Caspar Vi kunne omskrive dette når vi er færdige med programmet? -Troels}
\fxnote{Vi kunne med fordel definere flere af disse som akronymer i rapporten, hvilket vi har en decideret
pakke til at håndtere. --Tristan}

\input{chapters/management_systemer.tex} % Hvorfor to gange?? --Tristan
...
består af 3 applikationer, StackTrack, VesselValet og Service Request. \fxnote{Skal måske ændres til at hedder
funktioner i stedet for applikationer? Nej, en funktion er vel en del af er program (andet ord for
applikation) -Troels} StackTrack benyttes, når medlemmerne selv sejler deres både, hvorimod VesselValet, er

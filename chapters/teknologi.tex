...
I det følgende kapitel findes en analyse af de programmer, som på nuværende tidspunkt er state of the art inden for administration af sejlklubber.\fxnote{Caspar: Indledningen stemmer ikke overens med indholdet, management systemer falder udenfor? (Søren) : "Forinden dette gives en beskrivelse af hvordan projektgruppen definerer et management system, hvilket er det Sejlklubben Sundet har behov for, på baggrund af analysen i forrige kapitel? }

\section{Management systemer}\label{subsec:management-systemer}\fxnote{Jeg synes vi bør redefinere management systemer i dette afsnit, og skrive det om fra bunden, hva' tænker i ? (Søren)}
...
BoatCloud består af 3 applikationer, StackTrack, VesselValet og Service Request.\fxnote{Tristan: Bør vi ikke også lige nævne hvad ``Service Request'' gør?}
...
Denne applikation er også webbaseret, og gør det muligt for en bådklub at tilføje hvilke både, samt hvor disse er fortøjnet i havnen. \fxnote{Iflg ordbogen findes ordet fortøjnet ikke, skal vi skrive lokaliseret?(Søren) Tristan: Eller bare ``fortøjet''.} \fxnote{Tristan: Sætningen giver ikke mening. Vi starter på en sætning med ``tilføje hvilke både,'', men afslutter den aldrig.}
...
ForeningLet er en applikation, som adskiller sig fra de andre ved ikke at henvende sig specifikt til én type klub, desuden er det en dansk applikation. \fxnote{Caspar: er det ikke ligegyldigt at det er dansk? Tristan: Kun hvis de andre to programmer har korrekte, danske oversættelser, samt dansk support. Ellers vil jeg mene, at det er ganske relevant for eksempelvis ældre brugere.}
...
Dog er der ikke nogen af disse tre programmer, der har undervisningsfunktioner, hvilket var efterspurgt af Sejlklubben Sundet.\fxnote{Marc: Dette er som sådan ikke efterspurgt af Sundet da vi kun har været i kontakt med en forhenværende skolechef som blot nævnte at det kunne være rart i et interview, skriv i stedet: Hvilket Jacob Nørbjerg gjorde udtryk for kunne være brugbart i <interview reference>} Derfor menes der, at der her findes en mangel indenfor de produkter, der allerede findes.
...
Et produkt med undervisningsfunktioner vil derfor kunne indtage det ``hul'', som de nuværende produkter har efterladt. \fxnote{Troels: Genskriv denne sætning ?(Søren) Når du ikke selv gider finde på noget så gør jeg det da bare Troels :P : Et lignende produkt med undervisningsfunktioner vil derfor kunne formodes at være en bedre løsning for sejlklubben Sundet.}

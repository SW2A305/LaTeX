...
hjemmefra. \fixme{Lang knudret sætning overvej omformulering}
...
firmaer have forskellige måder at gøre tingene på, bl.a. hos firmaet \textit{TransIP}\fixme{Hvad er dette? Et firma?} skal brugeren selv lave en kopi af alle
...
\subsubsection*{Virtuelle servere}\fixme{Overvej https://www.vpspro.dk/ her, det er et plus at det er dansk og windows.}
...
-Caspar Vi kunne omskrive dette når vi er færdige med programmet? -Troels} \input{chapters/management_systemer.tex}
...
applikationer, StackTrack, VesselValet og Service Request. \fxnote{Skal måske ændres til at hedder funktioner i stedet for applikationer? Nej, en funktion er vel en del af er program (andet ord for applikation) -Troels} 

...
I dette afsnit vil projektets proces\fxnote{Troels: projektgruppens arbejdsprocess *} for udviklingen af programmet beskrives, som baseres på et begreb kaldet ``agile software development''.
...
Ved denne metode programmerer to programmører på en enkelt computer, med en fører og en observatør, for øget kodekvalitet.\citep{agile_software}\fxnote{Nikolaj: Er det kun her informationerne kommer fra? Synes ikke umiddelbart der står noget om pair programming.}

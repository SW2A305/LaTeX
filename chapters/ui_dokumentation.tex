...
Øverst ses login-vinduet, herfra logger brugeren ind med sine login informationer, eller en gæst kan logge ind ved at trykke på knappen ``login som gæst''.
...
Hovedvinduet tilgås via loginvinduet, som starter ved programstart eller ved at trykke på knappen ``logud'' inde fra hovedvinduet selv. 
...
\textbf{Brugergrænseflade}: 
Først vælges en båd, i en ComboBox.

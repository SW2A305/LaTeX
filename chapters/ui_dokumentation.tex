...
Hovedvinduet tilgås via loginvinduet, som starter ved programstart eller ved at trykke på ``log ud''-knappen inde fra hovedvinduet selv. \fxnote{Troels: Forvirende sætning}
...
Denne opløsning er valgt for at understøtte alt fra bærbare, med opløsninger som 1366x768 pixels i et vindue, og op til FullHD (1920x1080 pixels).\fxnote{Nikolaj: ``..alt fra bærbar'', ligger op til at der kommmer noget i stil med ``til smartphones''}

...
Dialogboksene åbnes ved at trykke på knapper inde i tabben, f.eks. under  \textbf{Bådreservation} kan opret reservations dialogen åbnes ved at trykke på knappen \textit{Reserver Båden}. \fxnote{Troels: Omformuler den sidste sætning?}
...
Hovedvinduet tilgås via loginvinduet, som åbner ved programstart eller ved at trykke på ``log ud''-knappen inde fra hovedvinduet selv. \fxnote{Troels: Forvirende sætning}
...
Denne opløsning er valgt for at understøtte alt fra bærbare, med opløsninger som 1366x768 pixels i et vindue, og op til FullHD (1920x1080 pixels).\fxnote{Nikolaj: ``..alt fra bærbar'', ligger op til at der kommmer noget i stil med ``til smartphones''}\fxnote{Marc: Denne formulering får det til at lyde som om alt andet end bærbar har større opløsning end 1366x768 forslag: ''Denne opløsning er valgt for at understøtte de mest anvendte opløsninger på computerplatformen''}
...
Ved tilmelding tilføjes personen, som er logget ind, til listen over tilmeldte personer.\fxnote{Nikolaj: Skal måske laves om hvis programmet bliver lavet om til kun at hente og gemme data ved start og lukning}
...
\textbf{Brugergrænseflade}: 
Brugergrænsefladen til loginvinduet er meget simpel og ligetil.\fxnote{Nikolaj: Talesprog?}
...
\textbf{Code-Behind}: 
Der er blevet brugt en \textbf{regular expression} til at tjekke, om den string brugeren angiver i de to TextBoxe for gæstens navne, er lovlige. \fxnote{Troels: lovlige? måske et andet ord her? Caspar: tilladt}

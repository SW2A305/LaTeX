...
Desuden er der indført logik, som sikrer at båden skal være ledig og ikke være skadet før reservationen kan gennemføres. \fxnote{Findes dette tjek??? - skadet(Søren)}

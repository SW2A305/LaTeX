...
beliggende i København, Aalborg sejlklub \fxnote{Var det ikke ``Vestre Bådelaug''?} som har til huse i Aalborg
...
\myref{chap:interessent-analyse-ved-sejlklubber}, samt en mere informativ hjemmeside, i forhold til de to
...
æresmedlemmer \citep{aalborg_sejlklub_vedtaegter}\fxnote{Kilden står ikke rigtig i bibtex da der skal være
\%-tegn der hvor der er mellemrum i URL'en, men rapporten kan ikke compiles hvis tegnene er der, så derfor er
de fjernet, du skal bare escape dem med en backscape så som Frivilligrapporten}.

Bådklubben Valby kategoriserer som A--, B-- og C--medlemmer, som indikerer hvilken bådtype de har
\citep{badklubben_valby_love}.

Fælles for medlemmerne er, at de gerne vil have informationer fra klubberne, så de ved hvilke begivenheder der
finder sted. Det kan være kapsejladser, foredrag, o.l.\fxnote{Mens det umiddelbart \textit{virker} som en god
formodning, så ér det blot en ubegrundet påstand, ikke?}
...
bådfører med, som man bliver ved at fuldføre to års undervisning, som nævnt i \myref{sec:sejlerskole}
...
over hvilke data der skal skrives ned, er udformet og kan findes i \myref{bilag:sundet}. Ved et kig på
...
interviewet, (se \myref{bilag:interview}) skulle man før i tiden ned i klubhuset, for at se om der var en
...
Da en softwareløsning, som ikke har forbindelse til nettet, blot vil være et system ligesom det gamle, hvor

...
\end{wrapfigure}
\subsection*{Navn: SailClubMember}
...
Positions feltet angiver desuden hvilke rettigheder de forskellige brugere har, f.eks. har en administrator lov til at tilgå alle funktioner i programmet, mens et medlem  ikke har lov til at gå ind i undervisnings delen af programmet.\fxnote{evt. ref til tabel over rettigheder}
...
\begin{wrapfigure}[9]{R}{0.37\textwidth}
    ...
    \vspace{-20pt}
    \begin{center}
        \includegraphics[width=0.35\textwidth]{UmlMini/Logbook.png}
    \end{center}
    \vspace{-10pt}
    \caption{Logbook}
\end{wrapfigure}
...
På samme måde findes der den reelle besætning, \textbf{ActualCrew}, hvor den besætning som var på turen indsættes.\fxnote{Lidt sjov sætning, ... der den... kan ikke helt tyde meningen} 
...
\fxnote{Formatet er stadig ikke 100 \% konsistent: Eventklassen vs event-klassen og andre fremmedeord om der skal være bindestreg eller bare sammensat og Lecture klassens generelt}

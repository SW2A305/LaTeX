...
\begin{wrapfigure}{l}{0.5\textwidth}
    ...
    \vspace{-20pt}
    \begin{center}
        \includegraphics[width=0.48\textwidth]{SailClubMember.png}
    \end{center}
    \vspace{-20pt}
...
\begin{wrapfigure}{l}{0.5\textwidth}
    ...
    \vspace{-10pt}
\end{wrapfigure}
Eventklassen er den klasse om bruges til oprettelse af  begivenheder, nødvendigvis ikke sejlbegivenheder, men generelle begivenheder. Et eksempel kunne være en grillaften eller natsejlads. Klassen består af 7 felter: EventDate, EventTitle, SignUpReq, Description, SignUpMsg, Created og så en liste af klassen Person, som hedder Participants.

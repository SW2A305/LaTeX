...
poster som kunne forekomme. \textbf{Følgende afsnit er skrevet ud fra egne erfaringer. Der er taget i betragtning, at disse erfaringer kan være specifikke for den enkelte klub hvor erfaringen stammer fra. Dog vurderes der at de forekommende administrative opgaver, er generelle opgaver, ikke enkelttilfælde.}\fxnote{Kan det skrives således?}
...
%Generelt er der set på følgende fritidsklubber:
%\begin{itemize}
%	\item Fodboldklub
%	\item Badminton- og tennisklub
%	\item Skytteklub
%	\item Golfklub
%	\item Haller
%	\item Ungdomsklub

...
\fixme{Sætningen i fed virker skal omformuleres. Man kunne evt. have en kilde over mest populære sportsgrene i danmark?} 
...
håndtering af det økonomiske eller noget helt andet. \fxnote{Hvad med at de er valgt fordi de har en facilitet at udleje?}
...
\item Medlemshåndtering; alder, spillestatus (skader, niveau ol.) \fxnote{På lavt niveau i fodbold holder klubben ikke styr på hvem der er skadet og spillernes niveau, det er noget en træner står for, listen skal nok modificeres}
\item Holdsammensætning og taktik \fxnote{Blev vi ikke enige om at dette er noget træneren selv holder styr på?}
\item Medlemsbetaling \fxnote{er det ikke bare et underpunkt til medlemdshåndtering?}
\item Kørsel til og fra arrangementer og lignende
\item Pointgivning ved lokale sportsarrangementer
\end{itemize}

Små lokale klubber kan også have vask af trøjer og andet udstyr gående på skift blandt medlemmerne, hvor forældrene
...
op til flere administrative opgaver, som der i mindre klubber kan forekomme at gøres manuelt.\fxnote{Den her sætning lyder forkert, kræver nok en omskrivning} 
...
\fixme{Fjern denne sætning, det kan ikke være så svært at skrive sit navn på en seddel og putte den på sit våben?}
...
hvornår på 1. hul.\fixme{Jeg ville mene at golfklubben er ret ligeglade med dette, tjek evt opponent gruppens rettelse her.; Mener at når man snakker med en klub og gerne vil have tid til at spille bliver der sat et bestemt tidspunkt hvor man må starte på et bestemt hul, så klubben har en smule administration på det punkt --Caspar} 

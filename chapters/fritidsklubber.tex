\chapter{Analyse af fritidsklubber} \label{Fritidsklubber} \fxnote{Skulle dette ikke være under problemanalyse da dette jo netop er en analyse? --Troels}
...
sportsgren som de repræsenterer; At det er populære og kendte sportsgrene.} \fxnote{Sætningen i fed virker
skal omformuleres. Man kunne evt. have en kilde over mest populære sportsgrene i Danmark?} De er også valgt ud
fra det faktum, at de ofte er drevet af frivilligt arbejde. Denne type frivilligt arbejde, er meget individuel
fra klub til klub, om det er undervisning, håndtering af det økonomiske eller noget helt andet. \fxnote{Hvad
med at de er valgt fordi de har en facilitet at udleje?}
...
\begin{itemize}
  ...
  \item Medlemshåndtering; alder, spillestatus (skader, niveau ol.) \fxnote{På lavt niveau i fodbold holder
        klubben ikke styr på hvem der er skadet og spillernes niveau, det er noget en træner står for, listen
        skal nok modificeres}
  \item Holdsammensætning og taktik \fxnote{Blev vi ikke enige om at dette er noget træneren selv holder styr
        på?}
  \item Medlemsbetaling \fxnote{er det ikke bare et underpunkt til medlemshåndtering?}
...
opgaver, som der i mindre klubber kan forekomme at gøres manuelt.\fxnote{Den her sætning lyder forkert, kræver
nok en omskrivning} Sådanne administrative opgaver kan være følgende:
...
våben. \fxwarning{Fjern denne sætning, det kan ikke være så svært at skrive sit navn på en seddel og putte den
på sit våben?}
...
starter hvornår på 1. hul. \fxnote{Jeg ville mene at golfklubben er ret ligeglade med dette, tjek evt
opponentgruppens rettelse her.; Mener at når man snakker med en klub og gerne vil have tid til at spille
bliver der sat et bestemt tidspunkt hvor man må starte på et bestemt hul, så klubben har en smule
administration på det punkt --Caspar} Herudover, kan det være centralt for klubben at have en måde at

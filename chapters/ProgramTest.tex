...
Unit tests tester metoder, properties, klasser og assemblies. \fxnote{Assemblies?? (Søren)}
...
Disse udvalgte kodestykker er valgt på baggrund af deres relevans for den overordnede struktur i programmet. \fxnote{Skal vi nævne noget med at det også er fordi de var lettere at lave tests til??}
...
Dermed testes der, altså om brugergrænsefladen hindrer programmets funktionalitet.\fxnote{Thomas: Slette 'altså', lyder talesprogsagtigt}

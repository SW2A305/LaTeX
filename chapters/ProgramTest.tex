...
Unit tests tester metoder, propertieser.         af en metode fungerer ved, at man giver metoden, som skal testes, et input, og ser om man får det forventede resultat.
...
Blandt andet bliver udvalgte modeller testet. \fxnote{Troels: Hvad menes der med klasser? er alt ikke inden i en klasse?, menes der her modeller eller hvad?}

...
Unit test af metoden fungerer ved, at man giver metoden, som skal testes, et input, og ser om man får det forventede resultat.
...
Herunder større afstand fra velkomstteksten til de to DataGrids, større overskrifter ved hver DataGrid, og lav de to DataGrids mindre da de hovedsageligt er tomme. 
...
Men da projektgruppen har en begrænset mængde tid, bliver disse rettelser ikke implementeret. 

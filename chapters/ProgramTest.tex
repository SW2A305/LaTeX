...
Noget af det mest gennemtestede kode, baseret på code coverage\fxfatal{Sørg for at dette er beskrevet andetsteds?}, er en hjælpeklasse, der importerer medlemmer fra en XML--fil, ind i det bagvedliggende persistenslag.
Denne hjælpeklasse benyttes ikke i programmet, men er forblevet deri som kode, med henblik på, at den kunne blive nyttig i forbindelse med en udvidelse af programmet.\fxfatal{Skal vi eventuelt nævne dette i perspektiveringen?}

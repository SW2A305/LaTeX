...
\fxnote{Troels: Flyt meta teksten herop ?}
\section{Data på sejlladser og medlemmer}

Dette bilag har til formål, at beskrive de informationer Sejlklubben Sundet påkræver af de sejlere, der sejler fra deres klub. \fxnote{Tristan: Fra?}
Herudover er der også beskrevet, hvilke informationer sejlerskolen Sundet \fxnote{Troels: Første gang sejlerskolen omtales på denne måde? ``Sejlkubben Sundets sejlerskole'' i stedet}skal bruge om deres elever for at kunne lade dem bestå.
...
Føreren skal også læse op i denne bog før en sejllads, for at sikre at man er klar over eventuelle skader på båden.\fxnote{Thomas: Måske ændre det til: ...slå op i denne bog...}
...
Det er ikke sikkert, at medlemmer har tid eller når at opdage tilmeldingsfristerne på diverse begivenheder, hvilket kan resultere i et lavere fremmøde, og mindre aktivitet i klubben.\fxnote{Tristan: ``har tid eller når at'' lyder underligt, gør det ikke?}
